...
| `OPENVIKING_ACCOUNT` | `account` | `default` | Tenant account for local/trusted mode |
| `OPENVIKING_USER` | `user` | `default` | Tenant user for local/trusted mode |
| `OPENVIKING_AGENT` | `agent` | (none) | Optional peer ID for separate assistant context |
