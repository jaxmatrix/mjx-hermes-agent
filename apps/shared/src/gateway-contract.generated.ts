...
export interface ProfilesListParams {
  ...
  preferred_session_ids?: Record<string, string> | null
}
...
export interface ProfilesListResult {
  ...
  canonical_session_title?: string | null
}
...
export interface ProfileRow {
  ...
  preferred_session?: ProfileCanonicalSession | null
...
/** The profile's "Bot Chat" registry row; ``resolved_id`` is the live compression tip. Also the shape of ``preferred_session`` (``methods_profiles._preferred_session_row``), where ``id`` is the caller's pin. */
...
export type CorrectionStatus = 'queued' | 'redirected' | 'steered' | 'rejected'
...
export interface SubagentEventPayload {
  ...
  budget_wrapup?: boolean | null
  worktree?: Record<string, unknown> | null
  missed_steer?: string | null
}
...
export interface BackendGatewayEventMap {
  ...
  /** A steer accepted mid-turn was never delivered before the turn ended; it is requeued as a prompt. */
  'steer.missed': SteerMissedPayload
