...
// Ported from apps/desktop/src/components/ui/switch.tsx (already keyed to the
// --dt-* token contract mobile now carries via the theme engine). Default size
// is bumped for touch.
...
const switchThumbVariants = cva(
  'pointer-events-none block rounded-full bg-foreground shadow-[0_0.0625rem_0.1875rem_color-mix(in_srgb,var(--dt-background)_50%,transparent)] ring-0 transition-transform data-[state=unchecked]:translate-x-0.5 data-[state=checked]:bg-background',
  {
    variants: {
      size: {
