...
// survives auto-compression's session-id rotation. To take this to the TUI
// later, promote this one atom to a backend SessionInfo.color field — the
// resolver below and the picker UI stay exactly as they are.
