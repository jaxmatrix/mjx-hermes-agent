...
// Ported from apps/desktop/src/app/shell/context-usage-panel.tsx. Fetches the
// live `session.context_breakdown` on open and renders a segmented usage bar +
// per-category legend. Works from the RPC alone, so it's correct even before the
// bar-label atom ($currentUsage) has a value.
