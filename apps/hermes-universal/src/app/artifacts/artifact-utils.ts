...
// Ported from apps/desktop/src/app/artifacts/artifact-utils.ts, trimmed for
// mobile: the Electron `readDesktopFileDataUrl` branch is dropped (media loads
// straight from the gateway HTTP URL via mediaExternalUrl). The extraction
// (scan assistant/tool messages for images/files/links) is verbatim.
