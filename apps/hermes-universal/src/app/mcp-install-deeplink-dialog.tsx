 ...
 *
 * Writes the APP-WIDE profile deliberately, not the Capabilities scope: a link
 * arrives from outside the app with no idea which profile is being edited, and
 * silently installing into some other profile's config would be the surprise.
 */
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1 text-xs text-muted-foreground">
            {m.serverJson}
            <pre className="max-h-64 overflow-auto rounded-md border border-border bg-muted/40 p-2 font-mono text-xs break-all whitespace-pre-wrap text-foreground">
