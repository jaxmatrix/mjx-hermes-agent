...
import { TerminalPaneChrome } from '../right-pane/terminal/chrome'
...
export const StatusbarSurface = memo(function StatusbarSurface({
  ...
  return <StatusbarControls data-tour="statusbar" items={statusbarItems} leftItems={leftStatusbarItems} />
})
