...
import { iconSize, Loader2, Mic } from '@/lib/icons'
import { cn } from '@/lib/utils'

import type { VoiceActivityState } from './types'

// Adapted from apps/desktop/src/app/chat/composer/voice-activity.tsx. Universal
// keeps the dictation activity indicator; the desktop VoicePlaybackActivity
// waveform (WebAudio analyser over a live <audio> element) is deferred —
// universal's TTS store exposes only a speaking flag (FIXME(chat-port)).
