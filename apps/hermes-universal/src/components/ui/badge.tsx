...
// Ported from apps/desktop/src/components/ui/badge.tsx. Small status/metadata tag.
// App radius (not a full pill); tones map to the shared accent/muted/destructive
// surfaces so badges read consistently.
