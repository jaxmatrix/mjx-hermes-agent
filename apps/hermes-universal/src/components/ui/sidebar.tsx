  ...
  return (
    <Tip label={label}>
      <button
        aria-label={label}
        className={cn(
          'absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:start-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[0.125rem] hover:after:bg-sidebar-border sm:flex',
