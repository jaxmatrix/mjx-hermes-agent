    ...
    <div data-slot="status-section">
      <div className="status-section-header flex items-center gap-1 pe-1">
        <button
          ...
          className="status-section-trigger flex min-w-0 flex-1 items-center gap-1.5 px-2 py-1 text-start text-xs font-normal text-muted-foreground/92 transition-colors hover:text-foreground/90"
