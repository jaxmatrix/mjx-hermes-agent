...
// Ported from apps/desktop/src/lib/statusbar.ts — the statusbar's shared
// formatters + the self-ticking LiveDuration. (compactPath was desktop-only for
// the workspace-cwd item, which is deferred here, so it's omitted.)
