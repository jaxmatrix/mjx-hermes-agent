...
// Fourteen curated presets for A/B in Settings → Notifications. Default is variant 1.
// Ported verbatim from apps/desktop/src/lib/completion-sound.ts (pure Web Audio).
