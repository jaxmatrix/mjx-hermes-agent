...
import { CHAT_EMPTY_AREA, COMPOSER_AREAS, universalHost as host, LocalizedTabTitle, PALETTE_AREA, SIDEBAR_PROFILE_GROUP_HEADER_AREA, translateNow } from '@hermes/plugin-sdk'
