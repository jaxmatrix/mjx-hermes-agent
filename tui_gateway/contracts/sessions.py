...
class SessionInterruptResult(Result):
    ...
    turn_isolation: bool | None = None
    was_running: bool | None = None  # a turn was live when Stop landed (settles a turn whose terminal frame was lost)
...
class CorrectionStatus(WireEnum):
    ...
    steered = "steered"  # redirect degraded to steer at a tool boundary (``server._agent_redirect_outcome``)
    rejected = "rejected"
