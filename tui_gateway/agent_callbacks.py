...
def _wire_callbacks(sid: str):
    ...
    # thread_only (fork 045d9b4364): secret_cb is bound to ONE session and turns for different sessions run
    # concurrently on their own threads; installed process-wide, the last turn to wire won and a secret prompt
    # raised by session A was emitted carrying session B's id.
