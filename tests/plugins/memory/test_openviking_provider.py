...
def test_declared_schema_covers_runtime_config_and_matches_defaults():
    ...
    # The runtime reads numeric defaults from _SETTING_SPECS (OpenVikingMemoryProvider._setting
    # falls back to spec["default"]); the old _DEFAULT_RECALL_* constants no longer exist.
    for key in (
        "recall_limit",
        ...
        runtime_default = openviking_module._SETTING_SPECS[key]["default"]
